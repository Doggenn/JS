...
for (let ave of aves) {
    document.write(`<p style="color: red;">${ave}</p>`);
}

for (let animals of zoo) {
    document.write(`<p style="color: orange;">${animals}</p>`);
    for (let animal of animals) {
        document.write(`<p style="color: blue;">${animal}</p>`);
    }
}